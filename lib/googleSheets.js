...
// --- ID FIJO DE LA CARPETA RAIZ ---
const ROOT_FOLDER_ID = '1Z9NmVy8je078U5aCD3p9ezzgnJ0KVziS';
...
// Usamos el ID fijo de la carpeta raíz
...
export async function crearCarpetaExpediente(numeroSAC, caratula) {
  ...
  try {
    // Paso 1: Obtener la carpeta raíz (ID fijo)
    console.log('🔍 PASO 1: Usando carpeta raíz fija...');
