...
export async function getResumenFinanzas(categoria, fechaInicio, fechaFin, usuario = null) {
  const finanzas = await getFinanzas(null, categoria, null, fechaInicio, fechaFin, usuario);
