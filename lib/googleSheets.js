...
// Función para obtener el próximo ID de cliente
...
// Función para crear un nuevo cliente (sin expediente)
export async function crearCliente(nombre, telefono, dni, domicilio) {
  try {
    ...
    // Preparar la fila (con campos vacíos para Numero_SAC, Caratula, Fuero, etc.)
    const fila = [
      nuevoId,                // ID_Cliente
